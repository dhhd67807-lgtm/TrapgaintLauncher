...
- Trapgaint 是一款基于 [PojavLauncher](https://github.com/PojavLauncherTeam/PojavLauncher) 开发的 Minecraft 启动器，它能够在 Android 设备上运行 [Minecraft: Java Edition](https://www.minecraft.net/)。
- Trapgaint 致力于优化用户体验，重新设计了应用界面，新增了更多实用的功能，旨在最大程度地降低游玩门槛，让更多人能够轻松体验 Minecraft 的乐趣。

> [!WARNING]
> 注意！此项目只是一个**社区改版**，就像 PojavLauncher 是基于 [Boardwalk](https://github.com/zhuowei/Boardwalk) 开发的一样。  
> 我们正在计划搭建官方网站 [trapgaint.com](https://trapgaint.com)，注意，我们的网站后缀名为`.cn`，不是`.com`！**那并不是我们搭建的网站**！我们不参与、不接受、不信任那个网站！请您仔细辨别并保护好自己的个人隐私！
